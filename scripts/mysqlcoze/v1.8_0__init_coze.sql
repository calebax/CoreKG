...
CREATE TABLE IF NOT EXISTS `knowledge` (
  ...
  `format_type` tinyint NOT NULL DEFAULT 0 COMMENT '0: Text 1: Table 2: Images 5: corekg',
  `corekg_detail_id` int NULL COMMENT '关联详情ID（非必填）',
  `source_type` varchar(32) NOT NULL DEFAULT 'coze' COMMENT 'source type',
  PRIMARY KEY (`id`),

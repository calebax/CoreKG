...
# =============================================================================
# ⚠️ DEPRECATED（已废弃）
# 本脚本仅做"接口通路自检"（路由+认证可达，code=500 也视为通道 OK），
# 不真正完成文件解析与问答。
#
# 需要验证「登录 → 建库 → 上传 → 解析完成 → 问答」完整链路，请改用：
#   ./scripts/verify/verify-kb.sh --mode local|compose [--cleanup]
# （见 README / docs/local-development.md 5.5 节）
# =============================================================================
# CoreKG 聚合单体接口通路验证脚本
#
# 功能：

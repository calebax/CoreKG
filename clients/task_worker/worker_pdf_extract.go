...
func pdfExtraTextCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			//logs.Infof("Starting PDF text extraction worker with worker ID: %s, task type: %s, base URL: %s", workerID, taskType, baseURL)
			ctx := lifecycle.Std().Context()
			loadConfig(ctx, configFile)
			_, err := runDaemonAPI(ctx)
			if err != nil {
				//logs.Errorf("Failed to start daemon API: %v", err)
				if !debug {
					return
				}
			}
			...
			if false {
				...
				payload := &ragtask.TaskPayload{
					FileURL:    "https://test-ccnerf-1251908240.cos.ap-beijing.myqcloud.com/pt/%E9%99%88%E5%AE%8F-2024105580929-%E4%B8%80%E7%A7%8D%E5%8F%91%E5%8A%A8%E6%9C%BA%E8%AF%95%E8%BD%A6%E6%95%B0%E6%8D%AE%E5%A4%84%E7%90%86%E6%96%B9%E6%B3%95%E3%80%81%E8%A3%85%E7%BD%AE%E3%80%81%E8%AE%BE%E5%A4%87%E5%8F%8A%E4%BB%8B%E8%B4%A8/%E4%B8%80%E5%AE%A1%E9%80%9A%E7%9F%A5%E4%B9%A6.pdf",
					UploadPath: "test/ttt3/",
				}

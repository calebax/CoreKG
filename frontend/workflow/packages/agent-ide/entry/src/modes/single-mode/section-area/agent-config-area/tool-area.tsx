...
export const ToolArea: React.FC<ToolAreaProps> = props => {
  ...
  const { node: DataSetArea, initRef: DataSetAreaRef, isDetailLoading } =
    useDataSetArea();
          ...
          <ToolView>
            ...
            >
              ...
              <DataSetArea
                ...
                toolKey={ToolKey.MULTIMODAL}
                title={I18n.t('dataset_detail_type_multimodal')}
                desc={I18n.t('bot_ide_knowledge_multimodal_desc')}
                formatType={FormatType.CoreKG_File}
              />

              <DataSetArea
                initRef={DataSetAreaRef}
                isDetailLoading={isDetailLoading}
                toolKey={ToolKey.QAPAIR}
                title={I18n.t('dataset_detail_type_qapair')}
                desc={I18n.t('bot_ide_knowledge_qapair_desc')}
                formatType={FormatType.Qapair}
              />

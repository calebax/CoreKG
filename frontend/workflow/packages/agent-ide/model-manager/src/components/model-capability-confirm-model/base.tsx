...
const getToolText = (toolKey: ToolKey) =>
  ({
    ...
    [ToolKey.MULTIMODAL]: I18n.t('dataset_detail_type_multimodal'),
    [ToolKey.QAPAIR]: I18n.t('dataset_detail_type_qapair'),
...
const getTitleByConfigType = (type: ModelFuncConfigType): string =>
  ...
  ({
    ...
    [ModelFuncConfigType.KnowledgeMultimodal]: I18n.t('dataset_detail_type_multimodal'),

...
import { SearchScope, search } from '@coze-arch/idl/intelligence_api';
...
export const ORDER_BY_FILTER_OPTIONS = [
  {
    value: search.OrderBy.UpdateTime,
    labelI18NKey: 'filter_order_by_update_time',
  },
  {
    value: search.OrderBy.CreateTime,
    labelI18NKey: 'filter_order_by_create_time',
  },
  {
    value: search.OrderBy.PublishTime,
    labelI18NKey: 'filter_order_by_publish_time',
  },
] as const;
...
export const FILTER_PARAMS_DEFAULT: FilterParamsType = {
  ...
  orderBy: search.OrderBy.UpdateTime,
};

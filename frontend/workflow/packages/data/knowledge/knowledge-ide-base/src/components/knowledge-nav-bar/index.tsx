...
import { useIsDetailLoading } from '@/hooks/use-case/use-is-detail-loading';
...
export const KnowledgeIDENavBar = ({
  ...
  const isDetailLoading = useIsDetailLoading();
          ...
          {isDetailLoading ? (
            ...
            <>
              <div className="flex items-center gap-[3px]">
                ...
                {/* corekg同步表格 */}
                {canEdit &&
                documentInfo?.format_type !== 11 &&
                documentInfo?.format_type !== 12 ? (
                ...
                {FLAGS['bot.data.knowledge_bots_count'] ? (
                  <div className={styles['bot-count']}>
                    ...
                    {!!dataSetDetail?.bot_used_count && (
                      ...
                      >
                        <IconCozInfoCircle
                          className={styles['bot-count-icon']}
                        />
                      </Tooltip>
                    )}
                  </div>

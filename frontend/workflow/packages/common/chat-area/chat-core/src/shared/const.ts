...
const DEFAULT_BETWEEN_CHUNK_TIMEOUT_MINUTES = 15;
const configuredBetweenChunkTimeoutMinutes =
  typeof window === 'undefined'
    ...
    ).__CONFIG?.between_chunk_timeout_minutes;

// Pull stream timeout
export const BETWEEN_CHUNK_TIMEOUT = (
  typeof configuredBetweenChunkTimeoutMinutes === 'number' &&
  configuredBetweenChunkTimeoutMinutes > 0
    ? configuredBetweenChunkTimeoutMinutes
    : DEFAULT_BETWEEN_CHUNK_TIMEOUT_MINUTES

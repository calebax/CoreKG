...
export const SCENE_RESPONSE_MAP = {
  ...
  [SceneType.BOT__VIEW__WORKFLOW]: (params, _) => {
    let url = `/coze/work_flow?space_id=${params.spaceID}&workflow_id=${params.workflowID}`;
  ...
  [SceneType.SOCIAL_SCENE__VIEW__WORKFLOW]: (params, _) => ({
    url: `/coze/work_flow?scene_id=${params.sceneID}&space_id=${params.spaceID}&workflow_id=${params.workflowID}`,

...
export const AllTypeContent: FC<ResultContent> = (props) => {
  ...
  if (!doc_search_result && !image_search_result && !video_search_result) {
    return tC('empty.noData')
  }
  const items: { value: any; title: string; type: ResultType }[] = [
    { value: doc_search_result, title: tC('file.doc'), type: 'doc' },
    { value: image_search_result, title: tC('file.image'), type: 'image' },
    { value: video_search_result, title: tC('file.video'), type: 'video' },
  ]
  return (

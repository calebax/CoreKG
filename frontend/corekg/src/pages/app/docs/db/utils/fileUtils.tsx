...
export const getFileIcon = (
  ...
  if (isFolder) {
    return <KnowledgeFile className='w-4 h-4 mr-2' />
  }
  ...
  switch (lowerFileType) {
    case 'doc':
      return <KnowledgeDoc className='w-4 h-4 mr-2' />
    case 'docx':
      return <KnowledgeDocx className='w-4 h-4 mr-2' />
    case 'xls':
      return <KnowledgeXls className='w-4 h-4 mr-2' />
    case 'xlsx':
      return <KnowledgeXlsx className='w-4 h-4 mr-2' />
    case 'xsl':
      return <KnowledgeXsl className='w-4 h-4 mr-2' />
    case 'csv':
      return <KnowledgeCsv className='w-4 h-4 mr-2' />
    case 'ppt':
      return <KnowledgePpt className='w-4 h-4 mr-2' />
    case 'pptx':
      return <KnowledgePptx className='w-4 h-4 mr-2' />
    case 'pdf':
      return <KnowledgePdf className='w-4 h-4 mr-2' />
    case 'png':
    case 'ofd':
      return <KnowledgePng className='w-4 h-4 mr-2' />
    case 'jpg':
      return <KnowledgeJpg className='w-4 h-4 mr-2' />
    case 'jpeg':
      return <KnowledgeJpeg className='w-4 h-4 mr-2' />
    case 'svg':
      return <KnowledgeSvg className='w-4 h-4 mr-2' />
    case 'txt':
      return <KnowledgeTxt className='w-4 h-4 mr-2' />
    case 'md':
      return <KnowledgeMd className='w-4 h-4 mr-2' />
    case 'mp4':
      return <KnowledgeMP4 className='w-4 h-4 mr-2' />
    case 'zip':
      return <KnowledgeZip className='w-4 h-4 mr-2' />
    default:
      return <KnowledgeWord className='w-4 h-4 mr-2' />
  }
}

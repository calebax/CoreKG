...
// GetUserSpaceRoles mocks base method.
func (m *MockUser) GetUserSpaceRoles(ctx context.Context, userID int64, spaceID []int64) (map[int64]int32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserSpaceRoles", ctx, userID, spaceID)
	ret0, _ := ret[0].(map[int64]int32)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUserSpaceRoles indicates an expected call of GetUserSpaceRoles.
func (mr *MockUserMockRecorder) GetUserSpaceRoles(ctx, userID, spaceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserSpaceRoles", reflect.TypeOf((*MockUser)(nil).GetUserSpaceRoles), ctx, userID, spaceID)
}

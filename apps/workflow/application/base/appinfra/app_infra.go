...
import (
	...
	coderunner "github.com/insmtx/corekg/apps/workflow/infra/coderunner/impl"
	messages2query "github.com/insmtx/corekg/apps/workflow/infra/document/messages2query/impl"
	nl2sql "github.com/insmtx/corekg/apps/workflow/infra/document/nl2sql/impl"
	ocr "github.com/insmtx/corekg/apps/workflow/infra/document/ocr/impl"
	parser "github.com/insmtx/corekg/apps/workflow/infra/document/parser/impl"
	rerank "github.com/insmtx/corekg/apps/workflow/infra/document/rerank/impl"
	searchstore "github.com/insmtx/corekg/apps/workflow/infra/document/searchstore/impl"
	"github.com/insmtx/corekg/apps/workflow/infra/es/impl/es"
	eventbus "github.com/insmtx/corekg/apps/workflow/infra/eventbus/impl"
	"github.com/insmtx/corekg/apps/workflow/infra/idgen/impl/idgen"
	"github.com/insmtx/corekg/apps/workflow/infra/imagex"
	"github.com/insmtx/corekg/apps/workflow/infra/imagex/impl/veimagex"
	"github.com/insmtx/corekg/apps/workflow/infra/orm/impl/mysql"
	storage "github.com/insmtx/corekg/apps/workflow/infra/storage/impl"
...
func Init(ctx context.Context, appCfg *conf.AppConfig) (*AppDependencies, error) {
	...
	if !ok {
		logs.WarnContextf(ctx, "workflow builtin chat model for knowledge recall not configured")
	}
...
func initImageX(ctx context.Context) (imagex.ImageX, error) {
	...
	uploadComponentType := appCfg.Workflow.Upload.ComponentType

...
const (
	formatTypeMultimodal dataset.FormatType = 11
	formatTypeDatabase   dataset.FormatType = 12
	formatTypeQAPair     dataset.FormatType = 13
	formatTypeExcel      dataset.FormatType = 14
)
...
func convertDocumentTypeEntity2Dataset(formatType model.DocumentType) dataset.FormatType {
	switch formatType {
	case model.DocumentTypeMultimodal:
		return formatTypeMultimodal
	case model.DocumentTypeDatabase:
		return formatTypeDatabase
	case model.DocumentTypeQAPair:
		return formatTypeQAPair
	case model.DocumentTypeExcel:
		return formatTypeExcel
	default:
...
func convertDocumentTypeDataset2Entity(formatType dataset.FormatType) model.DocumentType {
	switch formatType {
	case formatTypeMultimodal:
		return model.DocumentTypeMultimodal
	case formatTypeDatabase:
		return model.DocumentTypeDatabase
	case formatTypeQAPair:

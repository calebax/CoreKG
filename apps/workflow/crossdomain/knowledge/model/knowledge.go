...
const (
	...
	DocumentTypeMultimodal DocumentType = 11 // multimodal
	DocumentTypeDatabase   DocumentType = 12 // database
	DocumentTypeQAPair     DocumentType = 13 // Q&A pair
	DocumentTypeExcel      DocumentType = 14 // excel spreadsheet

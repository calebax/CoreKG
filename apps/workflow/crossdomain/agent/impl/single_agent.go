...
import (
	...
	model "github.com/insmtx/corekg/apps/workflow/crossdomain/agent/model"
...
func (c *impl) StreamExecute(ctx context.Context, agentRuntime *crossagent.AgentRuntime,
	...
	logs.InfoContextf(ctx, "agent StreamExecute req:%v, streamEvent:%v, err:%v", conv.DebugJsonToStr(singleAgentStreamExecReq), streamEvent, err)

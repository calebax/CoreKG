...
import (
	...
	product_public_api "github.com/insmtx/corekg/apps/workflow/api/model/marketplace/product_public_api"
...
func PublicSearchProduct(ctx context.Context, c *app.RequestContext) {
	...
	if err != nil {
		logs.ErrorContextf(ctx, "PublicSearchProduct failed: %v", err)
		internalServerErrorResponse(ctx, c, err)
		return
	}
...
func PublicSearchSuggest(ctx context.Context, c *app.RequestContext) {
	...
	if err != nil {
		logs.ErrorContextf(ctx, "PublicSearchSuggest failed: %v", err)
		internalServerErrorResponse(ctx, c, err)
		return
	}

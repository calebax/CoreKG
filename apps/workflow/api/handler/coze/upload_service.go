...
import (
	...
	upload "github.com/insmtx/corekg/apps/workflow/api/model/file/upload"
	uploadSVC "github.com/insmtx/corekg/apps/workflow/application/upload"
...
func ApplyUploadAction(ctx context.Context, c *app.RequestContext) {
	...
	coze_url, err := coresettings.GetCozeUrl()
	if err != nil {
		logs.ErrorContext(ctx,err.Error())
		return
	}
	host := ""
	host = strings.TrimPrefix(coze_url, "http://")
	host = strings.TrimPrefix(coze_url, "https://")

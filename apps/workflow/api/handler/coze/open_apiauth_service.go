...
import (
	...
	openapiauthApp "github.com/insmtx/corekg/apps/workflow/application/openauth"
...
func DeletePersonalAccessTokenAndPermission(ctx context.Context, c *app.RequestContext) {
	...
	if err != nil {
		logs.ErrorContextf(ctx, "OpenAuthApplication.DeletePersonalAccessTokenAndPermission failed, err=%v", err)
		internalServerErrorResponse(ctx, c, err)
		return
	}
...
func ListPersonalAccessTokens(ctx context.Context, c *app.RequestContext) {
	...
	if err != nil {
		logs.ErrorContextf(ctx, "OpenAuthApplication.ListPersonalAccessTokens failed, err=%v", err)
		internalServerErrorResponse(ctx, c, err)
		return
	}
...
func UpdatePersonalAccessTokenAndPermission(ctx context.Context, c *app.RequestContext) {
	...
	if err != nil {
		logs.ErrorContextf(ctx, "OpenAuthApplication.UpdatePersonalAccessTokenAndPermission failed, err=%v", err)
		internalServerErrorResponse(ctx, c, err)
		return
	}

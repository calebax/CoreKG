...
const (
	...
	// image
	DataSetType_CoreKGFile DataSetType = 11
	// image
	DataSetType_CoreKGExcel DataSetType = 12
)
...
func (p DataSetType) String() string {
	...
	case DataSetType_Image:
		return "Image"
	case DataSetType_CoreKGFile:
		return "CoreKGFile"
	case DataSetType_CoreKGExcel:
		return "DataSetType_CoreKGExcel"
	}
	return "<UNSET>"
}
...
func DataSetTypeFromString(s string) (DataSetType, error) {
	...
	case "CoreKGFile":
		return DataSetType_CoreKGFile, nil
	case "CoreKGExcel":
		return DataSetType_CoreKGExcel, nil
	}

...
type RegisterPluginMetaRequest struct {
	...
	Base          *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
	SourceType *string `thrift:"source_type,19,optional" form:"source_type" json:"source_type,omitempty" query:"source_type"`
}
...
var RegisterPluginMetaRequest_SourceType_DEFAULT string

func (p *RegisterPluginMetaRequest) GetSourceType() (v string) {
	if !p.IsSourceType() {
		return RegisterPluginMetaRequest_SourceType_DEFAULT
	}
	return *p.SourceType
}
...
func (p *RegisterPluginMetaRequest) IsSourceType() bool {

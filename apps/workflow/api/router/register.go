...
import (
	...
	coze "github.com/insmtx/corekg/apps/workflow/api/router/coze"
...
func GeneratedRegister(r *server.Hertz) {
	...
	coze.Register(r)
	// registerCustomRoutes registers hand-written routes that are not generated by IDL.
	coze.RegisterCorekgRoutes(r)
	coze.RegisterMigrationRoutes(r)

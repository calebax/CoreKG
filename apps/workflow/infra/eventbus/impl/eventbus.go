...
import (
	...
	"github.com/insmtx/corekg/apps/workflow/infra/eventbus/impl/kafka"
	"github.com/insmtx/corekg/apps/workflow/infra/eventbus/impl/nats"
	"github.com/insmtx/corekg/apps/workflow/infra/eventbus/impl/nsq"
	"github.com/insmtx/corekg/apps/workflow/infra/eventbus/impl/pulsar"
	"github.com/insmtx/corekg/apps/workflow/infra/eventbus/impl/rmq"
...
func (consumerServiceImpl) RegisterConsumer(nameServer, topic, group string, consumerHandler eventbus.ConsumerHandler, opts ...eventbus.ConsumerOpt) error {
	tp := conf.GetAppConfig().Workflow.MQ.Type
	switch tp {
	case "nsq":

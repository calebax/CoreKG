...
import (
	...
	"github.com/insmtx/corekg/apps/workflow/domain/openauth/openapiauth/internal/dal/model"
	"github.com/insmtx/corekg/apps/workflow/domain/openauth/openapiauth/internal/dal/query"
...
func (a *ApiKeyDAO) Create(ctx context.Context, do *entity.CreateApiKey) (*entity.ApiKey, error) {
	...
	_, md5Key := a.getAPIKey(poData.ID)
	...
	// TODO 这里返回的 api_key 是 md5 后的，而不是原始的 api_key
	doData.ApiKey = md5Key
	return doData, nil
}

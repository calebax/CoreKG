...
import (
	...
	"github.com/insmtx/corekg/apps/workflow/domain/conversation/agentrun/internal/dal/model"
	"github.com/insmtx/corekg/apps/workflow/domain/conversation/agentrun/internal/dal/query"
...
func (dao *RunRecordDAO) List(ctx context.Context, meta *entity.ListRunRecordMeta) ([]*entity.RunRecordMeta, error) {
	logs.InfoContextf(ctx, "list run record req:%v, sectionID:%v, limit:%v", meta.ConversationID, meta.SectionID, meta.Limit)

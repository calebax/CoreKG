...
import (
	...
	"github.com/insmtx/corekg/apps/workflow/infra/document/parser/impl/builtin"
	"github.com/insmtx/corekg/apps/workflow/infra/document/rerank/impl/rrf"
	"github.com/insmtx/corekg/apps/workflow/infra/document/searchstore"
	sses "github.com/insmtx/corekg/apps/workflow/infra/document/searchstore/impl/elasticsearch"
	hembed "github.com/insmtx/corekg/apps/workflow/infra/embedding/impl/http"
	...
	rdbservice "github.com/insmtx/corekg/apps/workflow/infra/rdb/impl/rdb"
...
func (suite *KnowledgeTestSuite) SetupSuite() {
	...
	mgrs = append(mgrs, sses.NewManager(&sses.ManagerConfig{
		Client:     knowledgeES,
		VectorMode: true,
		Embedding:  emb,
	}))

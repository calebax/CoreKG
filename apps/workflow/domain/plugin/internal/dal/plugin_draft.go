...
import (
	...
	plugin_develop_common "github.com/insmtx/corekg/apps/workflow/api/model/plugin_develop/common"
	pluginModel "github.com/insmtx/corekg/apps/workflow/crossdomain/plugin/model"
	"github.com/insmtx/corekg/apps/workflow/domain/plugin/conf"
	"github.com/insmtx/corekg/apps/workflow/domain/plugin/dto"
	"github.com/insmtx/corekg/apps/workflow/domain/plugin/entity"
	"github.com/insmtx/corekg/apps/workflow/domain/plugin/internal/dal/model"
...
func (p *PluginDraftDAO) Create(ctx context.Context, plugin *entity.PluginInfo) (pluginID int64, err error) {
	...
	err = table.WithContext(ctx).Create(&model.PluginDraft{
		...
		SourceType:  plugin.GetSourceType(),
	})
	if err != nil {
		return 0, err
	}

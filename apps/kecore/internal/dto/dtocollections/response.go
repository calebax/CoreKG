...
type MarkResourceCollectionResponse struct {
	apiobj.BaseResponse
	Response MarkResourceCollectionEmbedResponse `json:"response"`
}

type MarkResourceCollectionEmbedResponse struct {
}
...
type ListCollectionResponse struct {
	apiobj.BaseResponse
	Response ListCollectionEmbedResponse `json:"response"`
}

type ListCollectionEmbedResponse struct {
	apiobj.QueryResponse
	// Data 资源列表
	Data []ColItem `json:"data"`
}

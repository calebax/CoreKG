...
// Parse 实现 Parser 接口
func (p *JSONParser) Parse(content string) ([]ToolCall, string, error) {
...
func (p *JSONParser) parseJSON(jsonStr string) []ToolCall {
	var calls []ToolCall
...
func (p *StreamJSONParser) Add(chunk string) ([]ToolCall, string, bool) {
...
func (p *StreamJSONParser) getCallKey(call ToolCall) string {
	// 简单地使用 JSON 序列化作为键
...
func (p *StreamJSONParser) Flush() ([]ToolCall, string) {
